    ...
    <>
      <div className="min-h-screen relative bg-white">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute -left-10 -top-6 text-[520px] font-bold leading-none text-[#2c2c2c] select-none">X</div>
        ...
        <div className="relative max-w-md mx-auto px-4 pt-8 pb-24">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div className="p-3 rounded-xl bg-white text-center">
              ...
              <div className="text-xs text-white font-semibold">@De1Develbase_eth</div>
